...
箭头表示主动发送方向，内容为典型消息类型：

```
architect ──架构设计、接口定义──→ developer
architect ──审查关注点──────────→ reviewer
architect ──关键路径──────────→ tester
developer ──设计问题──────────→ architect
developer ──待审查通知─────────→ reviewer
developer ──测试需求──────────→ tester
reviewer  ──审查意见──────────→ developer
reviewer  ──架构问题──────────→ architect
reviewer  ──风险点───────────→ tester
tester    ──Bug 报告──────────→ developer
researcher ──调研结论─────────→ architect
tech-writer ──准确性审阅请求──→ reviewer
```
